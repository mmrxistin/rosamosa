    ...
    <div className="min-h-screen bg-[#f8f9fa] px-4 py-10">
      <div className="mx-auto max-w-7xl">
        <header className="mb-8 border-b-4 border-[#bb1919] pb-4">
          ...
          <h1 className="mt-1 text-3xl font-black tracking-tight md:text-4xl">Tadilat ve Renovasyon</h1>
          <p className="mt-1 text-gray-600">Bina güçlendirme, yenileme ve modernizasyon hizmetlerimiz</p>
        </header>
          ...
          <aside className="lg:col-span-4">
            <div className="border-t-4 border-[#bb1919] bg-white p-6 shadow-sm">
              ...
              <ul className="space-y-3 text-sm font-semibold">
                ...
                <li><a href="/malper/xane" className="text-[#bb1919] hover:underline">Tadilat ve Renovasyon</a></li>
