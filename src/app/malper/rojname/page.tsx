    ...
    <div className="min-h-screen bg-[#f8f9fa] px-4 py-10">
      <div className="mx-auto max-w-7xl">
        <header className="mb-8 border-b-4 border-[#bb1919] pb-4">
          ...
          <h1 className="mt-1 text-3xl font-black tracking-tight md:text-4xl">Anahtar Teslim Projeler</h1>
          <p className="mt-1 text-gray-600">Projeden teslime kadar tüm süreci üstlendiğimiz anahtar teslim inşaat projelerimiz</p>
        </header>
          ...
          <aside className="lg:col-span-4">
            <div className="border-t-4 border-[#bb1919] bg-white p-6 shadow-sm">
              ...
              <ul className="space-y-3 text-sm font-semibold">
                ...
                <li><a href="/malper/rojname" className="text-[#bb1919] hover:underline">Anahtar Teslim Projeler</a></li>
                <li><a href="/malper/penc" className="hover:text-[#bb1919]">Teknoloji ve Malzeme</a></li>
              </ul>
            </div>
          </aside>
        </div>
